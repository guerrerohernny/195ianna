...
window.IANNA_OPS = {
  ...
  catalogoPara(ap){
    ...
    // 1.95 (Etapa 5): el motor NO conoce funciones de UI. Qué flujo de pantalla
    // abre cada operación vive en modules/operaciones-ui.module.js (OPERACIONES_UI).
    ...
    return {
      ...
      // 1.95: sin descartes silenciosos — una operación sin nombre registrado se muestra con etiqueta derivada
      permitidas:d.permitidas.map(o=>({op:o, nombre:NOMBRES[o]||('⚙ '+o.replace(/_/g,' ')), futura:FUTURAS.includes(o)})),
      prohibidas:d.prohibidas.map(o=>({op:o, nombre:NOMBRES[o]||('⚙ '+o.replace(/_/g,' '))})),
    };
  },
};
...
/* 1.95: el modal ⚙ Operaciones (UI) vive en modules/operaciones-ui.module.js */
