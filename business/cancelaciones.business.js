...
// MIS INGRESOS
// ================================================================
/* 1.95: openCancelarVenta (UI de captura) vive en modules/operaciones-ui.module.js */
// ── SOLICITANTE ──
...
function _ejecutarCancelacionVenta(aid, motivo, destinoLote){
  ...
  IANNA_SYNC.refrescar(['apartados','inventario','dashboard','ingresos']); // 1.95: business no llama UI directa — SYNC es el único puente autorizado
